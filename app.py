...
st.markdown('This is an app that you can use to analyze stocks, portfolios and other things in the world of finance. Use the sidebar for all the modules. This is a work in progress app.')
